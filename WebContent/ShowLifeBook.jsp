...
<link rel="shortcut icon" type="image/png" href="img/colorworld.png"/>
	...
	$(document).ready(function(){
		...
		$("#pastebook").load("GetLifeBookForProfile.jsp?searchId="+searchId);
...
/*				count++;
	...
	function likeforlife(a)
	 {
	 	var liker=$("#liker"+a).val();
	 	var post=$("#tid"+a).val();
	 	var bname=$("#like"+a).val();
	 	 $.ajax({
		      type: "POST",
		       url: "likeForLifebookServlet",
	...
	<div id="mid">
		...
		<div id="midmid">
			...
			<div id="showmenubar">
				...
				<div id="menuitem3" class="activehover">
					<div id="lifebookitem"><center><a class="link" id="activelink" href="Profile?action=lifebook&searchId=<%=userId %>" style="cursor: pointer;">.Life Book</a></center></div>
				</div>
				<div id="menuitem4">
