...
<a id="next_page_button"></a>
				...
				<div id="mybook" style="display:none;">
					<%
					ResultSet myLife =(ResultSet) sd.getMyWholeLife(userId,userId,con);
					%>
					<div class="b-load">
					<%
					int count=0;
					...
					%>
						...
						<div id="page2<%=count %>" class="messagebookleftpage">
							...
							{
							%>
							<input type="hidden" name="tid" id="tid<%=count %>" value="<%=myLife.getString("tid") %>">
							<div id="messagebooklikearea">
								<div id="messagebookcounter">Likes: <a href="#" onmouseover="showLikers(<%=count %>)" data-display="mySite"><b><%=myLife.getString("likes") %></b></a></div>
							</div>
							<%
							}
							%>
