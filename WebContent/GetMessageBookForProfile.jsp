				...
				<div id="mainsubmid">
					...
					%>
						<div id="page1<%=count %>" class="messagebookrightpage">
							<div id="messagebookdateandtimearea1">
							...
							<input type="hidden" name="postId" id="postId<%=count %>" value="<%=myMessages.getString("pid") %>">			
						</div>
						<div id="page2<%=count %>" class="messagebookleftpage">
							...
							<div id="messagebookusernameandid">
								<div id="messagebookusername"><%=myMessages.getString("fullname") %></div>
...
<!-- 							<div id="messagebooklikebutton">
									<input type="button" class="history1" name="like" value="Like" />
								</div>  --> 
								<div id="messagebookcounter1">Likes: <a href="#" onmouseover="showLikers(<%=count %>)" data-display="mySite"><b><%=myMessages.getString("likes") %></b></a></div>
							</div>
						</div>
						<%
						}
